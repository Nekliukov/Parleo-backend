...
namespace Parleo.BLL.Services
{
    class UsersService
    {
        private DataContext _repository;
        ...
        public User Create(User user, string password)
        {
            ...
            if (_repository.Users.Any(x => x.Username == user.Username))
        ...
        {
            var user = _repository.Users.Find(userParam.Id);
            ...
            if (userParam.Username != user.Username)
            {
                ...
                if (_repository.Users.Any(x => x.Username == userParam.Username))
